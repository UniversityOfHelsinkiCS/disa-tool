module.exports = {
  up: (queryInterface, Sequelize) => queryInterface.changeColumn('self_assessment', 'fin_instructions', { type: Sequelize.TEXT }).then(() => (
  ...
  down: (queryInterface, Sequelize) => queryInterface.changeColumn('self_assessment', 'fin_instructions', { type: Sequelize.STRING }).then(() => (
