...
export const getInstancesOfCourse = (courseId) =>
    getJson(`/courses/${courseId}`)

export const getCourseInstanceData = (courseId) =>
    getJson(`/courses/instance/${courseId}`)

export const getCourseTasks = (instance) =>
    postJson(`/courses/instance/${instance.id}/tasks`, { instance })

export const getCourseInstance = (id) => getJson(`/course-instances/${id}`)

export const toggleCourseInstanceActivity = (id) =>
    putJson(`/courses/instance/${id}/toggle`, null)
