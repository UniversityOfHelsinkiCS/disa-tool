...
export const changeCourseRole = (data) =>
    putJson('/course-persons/course-role', data)

export const deleteCoursePerson = (coursePerson) =>
    postJson('/course-persons/delete', coursePerson)
