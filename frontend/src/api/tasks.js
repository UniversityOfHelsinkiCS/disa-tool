...
export const postTaskResponses = (updatedTasks) =>
    postJson('/tasks/responses', updatedTasks)

export const addObjective = (data) => postJson('/tasks/objectives/attach', data)

export const removeObjective = (data) =>
    postJson('/tasks/objectives/detach', data)
...
export const edit = (data) =>
    putJson(`/tasks/${data.id}`, { ...data, id: undefined })

export const editObjectives = (data) => postJson('/tasks/objectives/edit', data)

export const objectivesDetails = (data) =>
    getJson(`/tasks/${data.id}/objectives`)
