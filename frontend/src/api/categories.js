...
export const getCategoriesForCourse = (courseId) =>
    getJson(`/categories/${courseId}`)

export const getCourseData = (id) =>
    getJson('/categories', { courseInstanceId: id })
...
export const edit = (data) =>
    putJson(`/categories/${data.id}`, { ...data, id: undefined })
