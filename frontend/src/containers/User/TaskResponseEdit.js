...
const TaskResponseEdit = (props) => {
  ...
  const  updateTask = (e, { task }) => {
    switch (e.target.name) {
      case 'input':
        setPopUp({...popUp, show: true, task: { ...popUp.task, points: e.target.value }, person: popUp.person })
        break
      case 'update': {
        const filteredTasks = updatedTasks.filter(et =>
              ...
              panels={[{
                ...
                content: {
                  ...
                  content: <UploadResponsesPage
                    ...
                    updateHandler={updateTasksFromFile}
                  />
                }
              }]}
            />
          ...
          <Grid.Column>
            <Segment>
              ...
              <Button
                ...
                onClick={submitTaskUpdates}
              />
              <Button
                color="red"
                content="Peru kaikki muutokset"
                onClick={() => setState({ updatedTasks: [] })}
              />
              {!selectedType ?
