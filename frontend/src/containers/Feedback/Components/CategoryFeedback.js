                    ...
                    <Card fluid color="red">
                        <Card.Content>
                            ...
                            <Card.Description textAlign="center">
                                <h4>
                                    {translate('selfAssessedGrade')}:{' '}
                                    {questionModule.grade_name ||
                                        questionModule.grade}
                                    {props.teacher && verification && (
                                        <Fragment>
                                            <br />
                                            {translate('machineGrade')}:{' '}
                    ...
                    {feedback ? (
                        <Card fluid color="red">
                            <Card.Content>
                                ...
                                <Card.Description textAlign="center">
                                    {
                                        feedback.categoryFeedback.find(
                                            (f) =>
                                                f.categoryId ===
                                                questionModule.id
                                        ).text
                            ...
                            <Card.Content>
                                {feedback.categoryFeedback
                                    .find(
                                        (f) =>
                                            f.categoryId === questionModule.id
                                    )
                                    .skillLevelObjectives.map(
                                        (skillLevel, i) => (
                                            <Accordion
                                                key={i}
                                                                    ...
                                                                    (
                                                                        ...
                                                                        objective.include ? (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <Progress
                                                                                    size="small"
                                                                                    percent={objective.percentageDone.toFixed(
                                                                                        1
                                                                                    )}
                                                                                    progress={
                                                                                        props.teacher
