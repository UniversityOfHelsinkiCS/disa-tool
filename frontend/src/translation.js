    ...
    */
        ...
        grades: {
            common: {
                ...
                needed_for_grade: [
                    ...
                    'Vaadittu suoritustaso',
                ],
                prerequisite: [
                    'Prerequisite grade for earning this grade',
                    'Vaadittu alempi arvosanasuoritus',
                ],
            },
            CategoryGradeTable: {
                header: [
                    'Edit grades by category',
                    'Muokkaa arvosanoja osioittain',
                ],
    ...
    SelfAssessmentForm: {
        SelfAssessmentFormPage: {
            ...
            back_button: ['Back to course page', 'Takaisin kurssisivulle'],
            defineMatrixFirstError: [
                'Define course-objective matrix first',
                'Määritä kurssin tavoitematriisi ensin',
            ],
        },
        QuestionModules: {
    ...
    UserPage: {
        ...
        ManageCoursePeople: {
            add_a_user: [
                ...
                'Lisää käyttäjä kurssille',
            ],
            add_teacher: ['Add teacher', 'Lisää opettaja'],
            select_teacher: [
                'Select teacher(s)',
                'Valitse lisättävät opettajat',
            ],
            add_student: [
    ...
    SelfAssessmentList: {
        SelfAssessmentListPage: {
            ...
            generate_feedback: [
                ...
                'Luo palautteet uudestaan',
            ],
            selected_header: [
                'Selected self-asseessments',
                'Valitut itsearviot',
            ],
            'non-selected_header': [
