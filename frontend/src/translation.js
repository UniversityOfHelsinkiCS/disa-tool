...
When using backticks you can also use "quotes" and 'hyphens' in the text.
  ...
  InfoBox: {
    ...
    CoursesPage: {
      Teacher: ['Here you can add a course', 'Tästä voit lisätä kurssin'],
    },
    UserPageTasks: {
      Teacher: ['English translation for teachers.', 'Suomenkielinen käännös opettajille.'],
      Student: ['English translation for students.', 'Suomenkielinen käännös opiskelijoille.'],
    },
  },
  Nav: {
    navbar: {
      logout: ['Log out', 'Kirjaudu ulos'],
      logout_success: ['You have logged out successfully', 'Olet kirjautunut ulos'],
      admin: ['Admin', 'Admin'],
  ...
  Admin: {
    ...
    AdminPage: {
      ...
      search_placeholder: ['Search by name or student number', 'Hae nimellä tai opiskelijanumerolla'],
    },
  },
  Home: {
    HomePage: {
      ...
      background_link_1: ['a study on self-asseessments', 'itsearviointitutkimuksesta'],
      ...
      background_link_2_2: ['the Faculty of Educational Sciences', 'kasvatustieteellinen tiedekunta'],
  ...
  Course: {
    ...
    grades: {
      ...
      EditGradesTab: {
        header: ['Create and modify the grading criteria', 'Lisää ja muokkaa kurssin arvosanoja'],
      },
      Grade: {
        delete_header: ['Delete grade', 'Poista arvosana'],
        delete_prompt_1: ['Are you sure you want to remove the grade', 'Poistetaanko arvosana'],
      },
    },
    matrix: {
      CreateCategoryForm: {
      ...
      CreateObjectiveForm: {
        ...
        prompt_1: ['Add a new objective to category', 'Lisää uusi oppimistavoite osioon'],
      ...
      MatrixObjective: {
        ...
        delete_prompt_1: ['Really remove objective', 'Poistetaanko oppimistavoite'],
    ...
    tasks: {
      ...
      AddTaskForm: {
        ...
        prompt_1: ['Add a new task to the course', 'Lisää uusi tehtävä kurssille'],
      },
      EditTaskForm: {
    ...
    types: {
      ...
      TypeHeader: {
        ...
        delete_prompt_1: ['Really remove type header', 'Poistetaanko tyyppiotsake'],
      },
    },
  },
  CreateCourse: {
  ...
  CourseList: {
    CreateInstanceForm: {
      ...
      trigger: ['Create a new instance of this course', 'Luo uusi instanssi tästä kurssista'],
      dropdown_label: [
    ...
    CourseListPage: {
      ...
      instance_prompt: ['Now, choose a course instance.', 'Valitse vielä kurssi-instanssi.'],
  ...
  SelfAssessment: {
    ...
    AssessmentButtons: {
      categoryButton: ['Category based self-asseessment', 'Itsearvio kategorioiden pohjalta'],
      objectiveButton: ['Objective based self-asseessment', 'Itsearvio tavoitteiden pohjalta'],
    },
  },
  FeedbackPage: {
    common: {
    ...
    ObjectivesFeedback: {
      ...
      objectiveAssessment: {
        good: ['I know the the objectives of this category well', 'Osaan osion tavoitteet hyvin'],
        decent: ['Osaan osion tavoitteet kohtalaisesti', 'I know the the objectives of this category decently'],
        poor: [
  ...
  SelfAssessmentForm: {
    SelfAssessmentFormPage: {
      ...
      modalContent1: ['You have empty explanation text fields', 'Sinulla on tyhjiä perustelukenttiä vastauksille'],
      modalContent2: [
    ...
    QuestionModules: {
      CategoryQuestionModule: {
        ...
        assessment: ['Assess your skills by grade', 'Arvioi osaamisesi arvosanalla'],
        gradeSelect: ['Select a grade', 'Valitse arvosana'],
        basis: ['Explanation for grade', 'Perustelut arvosanalle'],
        writeBasis: ['Write an explanation for your grade', 'Perustelut arvosanalle'],
      },
      EditCategoryModule: {
        label: ['Explanation for grade', 'Perustelut arvosanalle'],
        includedButton: ['Included in assessment', 'Mukana itsearviossa'],
        notIncludedButton: ['Not included in assessment', 'Ei mukana itsearviossa'],
      },
      OpenQuestionModule: {
        placeholder: ['Write your response here', 'Kirjoita vastaus tähän'],
        modalHeader: ['Remove open question', 'Poista avoin kysymys'],
        modalConfirmation: ['Do you wish to remove the open question', 'Haluatko poistaa avoimen kysymyksen'],
        modalCancel: ['Cancel', 'Peru'],
        popup: ['Remove the open question from here', 'Poista avoin kysymys tästä'],
      },
    },
    UpOrDownToggle: {
  ...
  UserPage: {
    common: {
      ...
      create_self_assessment_target: ['Create objective based assessment', 'Luo tavoitepohjainen itsearviointi'],
      create_self_assessment_category: ['Create category based assessment', 'Luo kategoriapohjainen itsearviointi'],
    ...
    CourseInfo: {
      edit_self_assessments: ['Edit self-asseessments', 'Muokkaa itsearviointeja'],
      edit_course: ['Edit course', 'Muokkaa kurssia'],
      close_course: ['Course open', 'Kurssi avoinna'],
      manage_course_people_tasks: ['Manage course people and tasks', 'Hallinnoi kurssin osallistujia ja tehtäviä'],
    ...
    ManageCoursePeople: {
      ...
      search_student: ['Search people outside of course', 'Etsi kurssin ulkopuolisia henkilöitä'],
      teacher: ['Teacher', 'Opettaja'],
      student: ['Student', 'Opiskelija'],
      manage_course_people: ['Manage people on course', 'Hallinnoi kurssin osallistujia'],
      remove_from_course: ['Remove from course', 'Poista kurssilta'],
    },
    UploadResponses: {
      CsvTable: {
        look_at_csv: ['Inspect csv file contents', 'Katso csv-tiedoston sisältöä'],
      },
      PointMapping: {
        point_mapping_text: [
    ...
    TeacherAssesmentList: {
      ...
      delete_prompt_1: ['Really remove self-asseessment', 'Poistetaanko itsearviointi'],
  ...
  SelfAssessmentList: {
    SelfAssessmentListPage: {
      ...
      'non-selected_header': ['Non-selected self-asseessments', 'Ei-valitut itsearviot'],
    },
    ResponseList: {
      Filter: ['Filter by name or student number', 'Rajaa nimen tai opiskelijanumeron avulla'],
    ...
    SelfAssesmentCSVDownload: {
      download_csv: ['Download responses as csv', 'Lataa vastaukset csv-muodossa'],
    },
  },
  utils: {
    components: {
