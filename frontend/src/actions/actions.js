...
export const updateSelfAssesmentAction =
    (assessmentData) => async (dispatch) => {
        try {
...
export const toggleAssessmentAction =
    (assessmentId, attribute) => async (dispatch) => {
        dispatch({
...
export const setAssessmentStatusAction =
    (assessmentId, attributes) => async (dispatch) => {
        dispatch({
            type: types.SELF_ASSESSMENT_STATUS_ATTEMPT,
            payload: assessmentId,
        })
        try {
            const { data } = await setAssessmentStatus(assessmentId, {
                attributes,
            })
            dispatch({
...
export const createSelfAssessmentResponseAction =
    (responseData) => async (dispatch) => {
        dispatch({
...
export const updateCoursePersonsAction =
    (coursePersons) => async (dispatch) => {
        dispatch({
...
export const updateCategoryGradesAction =
    (categoryGrades) => async (dispatch) => {
        dispatch({
