...
test('test', async ({ page }) => {
  ...
  await expect(page.locator("[data-testid='self-assessment-form-page']")).toHaveScreenshot('self-assessment-category-page.png');
  ...
  await expect(page.locator("div[data-testid='edit-category-module-10']")).toHaveScreenshot( 'edit-category-module-before-clicks.png' );
  ...
  await expect(page.locator("[data-testid='edit-category-module-10']")).toHaveScreenshot( 'edit-category-module-after-clicks.png' );
