...
test('You can create a course - singular language', async ({ page }) => {
  ...
  await page.locator('input[name="all-name-input"]').fill('Uusi kurssi')
  ...
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Uusi kurssi 2023')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  await page.waitForTimeout(200)
  await expect(page).toHaveScreenshot('new-course.png')
  await page.getByRole('button', { name: 'Vaihda nimeä' }).click()
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Uusi kurssi  - nimeä vaihdettu')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  await page.locator('button').nth(2).click()
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Uusi kurssi 2023 - nimeä vaihdettu')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  ...
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Uusi osio')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  await page.locator('thead').getByRole('button').click()
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Taitotaso 1')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  await page.getByRole('row', { name: 'Uusi osio' }).getByRole('button').nth(2).click()
  await page.locator('input[name="all-name-input"]').click()
  await page.locator('input[name="all-name-input"]').fill('Opi asia')
  await page.getByRole('button', { name: 'Tallenna' }).click()
  await page.waitForTimeout(200)
