...
const task = {
    ...
    description:
        'Tässä tehtävässä sinun tulee tehdä voltti, eli hypätä ja pyörähtää täysi kierros sivuttaisakselisi ympäri.',
    max_points: 3,
...
describe('Task component', () => {
    ...
    describe('DeleteForm component', () => {
        ...
        it('includes task names in prompt.', () => {
            ...
            expect(
                prompt.filter((segment) => segment.includes(task.name)).length
            ).toBeGreaterThan(0)
        })
