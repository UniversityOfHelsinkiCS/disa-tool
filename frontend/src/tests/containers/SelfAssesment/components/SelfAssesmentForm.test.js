...
describe('Self assessment form', () => {
    ...
    describe.skip('with edit, new and category', () => {
        ...
        it('renders correctly', () => {
            expect(wrapper.find('.SelfAssessmentFormPage').exists()).toEqual(
                true
            )
        })
        it('shows the correct label on the button', () => {
            expect(wrapper.find(Button).at(3).props().children).toEqual(
                'Tallenna'
            )
        })
        ...
        describe.skip('with edit, new and objective', () => {
            ...
            it('contains question modules of type objective', () => {
                const questionModule = wrapper
                    .find(SelfAssessmentSection)
                    .at(0)
                    .prop('QuestionModule')
