export const initForm = (payload) => {
    ...
    formInfo.push(
        {
            id: 1,
            prefix: 'Fin',
            value: 'Itsearviointitehtävä',
            type: 'fin_name',
        },
        {
            id: 2,
            prefix: 'Eng',
            value: 'Self-assessment task',
            type: 'eng_name',
        },
    ...
    data.instructions = {
        header: formInfo.slice(3, 6).find((f) => f.type === instructions)
            .header,
        ...
        return {
            ...
            assesmentResponse: {
                ...
                questionModuleResponses:
                    state.assesmentResponse.questionModuleResponses.map(
                        (qmRes) =>
                            qmRes.id === id
                                ? {
                                      ...qmRes,
    ...
    return {
        ...
        assesmentResponse: {
            ...
            finalGradeResponse: {
                ...
                grade_name:
                    name ||
                    state.assesmentResponse.finalGradeResponse.grade_name,
            },
        },
    }
}
