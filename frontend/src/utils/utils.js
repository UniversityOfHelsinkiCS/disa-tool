...
export const getJson = (path, params) =>
    axios.get(`${BASE_PATH}${path}`, getConfig(params))

export const postJson = (path, data) =>
    axios.post(`${BASE_PATH}${path}`, data, getConfig(null))

export const putJson = (path, data) =>
    axios.put(`${BASE_PATH}${path}`, data, getConfig(null))

export const deleteCall = (path) =>
    axios.delete(`${BASE_PATH}${path}`, getConfig(null))
